...
const CaptainSignup = () => {
    ...
    return (
        <div>
            ...
            <div>
                <p className="text-[10px] leading-tight mt-3 mb-3">This site is protected by reCAPTCHA and <span className="underline">Google Privacy Policy</span> and <span className="underline">Terms of Service</span> apply.</p>
            </div>
        </div>
        </div>
    ) 
