  ...
  return (
    ...
    <h5 className="p-1 text-center w-[93%] absolute top-0" onClick={()=>{
          ...
          <div className='mt-6 w-full'>
            ...
            }} className="w-full flex justify-center mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg">Finish Ride</Link>
            
           <p className='text-xs mt-10 '>click on finish button if you got payment and ride is completed.</p>     
          </div>
          </div>
    </div>
  )
